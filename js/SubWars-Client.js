...
return self;},
args: ["html"],
source: unescape('renderMapOn%3A%20html%0A%09%7C%20svg%20%7C%0A%09html%20div%20id%3A%20%27map%27.%0A%09%3Csvg%20%3D%20document.getElementById%28%22map%22%29.appendChild%28org.polymaps.svg%28%22svg%22%29%29%3E.%0A%09map%20%3A%3D%20window%20org%20polymaps%20map%20container%3A%20svg.%0A%09map%20zoom%3A%2017.%0A%09%22midnight-commander%3A%20999%22%0A%09%22SW-black-basic%3A%2052152%22%0A%09%3Cself%5B%27@map%27%5D.add%28org.polymaps.image%28%29%0A%09%09.url%28org.polymaps.url%28%22http%3A//%7BS%7Dtile.cloudmade.com%22%0A%09%09+%20%22/4dc7790c1c744bdab4909fdb857d642d%22%20//%20subwars%0A%09%09+%20%22/52152/256/%7BZ%7D/%7BX%7D/%7BY%7D.png%22%29%0A%09%09.hosts%28%5B%22a.%22%2C%20%22b.%22%2C%20%22c.%22%2C%20%22%22%5D%29%29%29%3B%3E.'),
...
return self;},
args: [],
source: unescape('startTracking%0A%09geo%20watchPosition%3A%20%5B%3Aposition%7C%0A%09%09self%20updateLat%3A%20position%20coords%20latitude%0A%09%09%09lng%3A%20position%20coords%20longitude%5D'),
messageSends: ["watchPosition:", "updateLat:lng:", "latitude", "coords", "longitude"],
referencedClasses: []
}),
smalltalk.SubWarsApp);
...
return self;},
args: [],
source: unescape('stopTracking%0A%09geo%20clearWatch'),
messageSends: ["clearWatch"],
referencedClasses: []
}),
smalltalk.SubWarsApp);
...
return self;},
args: [],
source: unescape('destroy%0A%09geo%20ifNotNil%3A%20%5Bgeo%20clearWatch%5D.%0A%09client%20ifNotNil%3A%20%5Bclient%20disconnect%5D.%0A%09div%20ifNotNil%3A%20%5Bdiv%20asJQuery%20remove%5D'),
messageSends: ["ifNotNil:", "clearWatch", "disconnect", "remove", "asJQuery"],
referencedClasses: []
}),
smalltalk.SubWarsApp);
...
return self;},
args: [],
source: unescape('updateNav%0A%09nav%20contents%3A%20%5B%3Ahtml%7C%0A%09%09html%20li%20with%3A%20%5Bhtml%20a%20with%3A%20%27IDE%27%3B%20href%3A%20%27%23ide%27%3B%20onClick%3A%20%5B%3Ae%7C%20e%20preventDefault.%20Browser%20openOn%3A%20SubWarsApp%5D%5D.%0A%09%09consoleForm%20%3A%3D%20html%20form%20class%3A%20%27form-search%20navbar-search%20pull-left%27%3B%20with%3A%20%5B%0A%09%09%09html%20input%0A%09%09%09%09type%3A%20%27text%27%3B%0A%09%09%09%09id%3A%20%27console%27%3B%0A%09%09%09%09placeholder%3A%20%27Chat%27%3B%0A%09%09%09%09class%3A%20%27search-query%20span1%27%5D.%0A%0A%09%09consoleForm%20asJQuery%20bind%3A%20%27submit%27%20do%3A%20%5B%3Ae%20%3Ainput%7C%0A%09%09%09e%20preventDefault.%0A%09%09%09input%20%3A%3D%20%27%23console%27%20asJQuery.%0A%09%09%09self%20processConsoleCommand%3A%20input%20val.%0A%09%09%09input%20val%3A%20%27%27%5D%5D'),
messageSends: ["contents:", "with:", "li", "href:", "onClick:", "preventDefault", "openOn:", "a", "class:", "type:", "id:", "placeholder:", "input", "form", "bind:do:", "asJQuery", "processConsoleCommand:", "val", "val:"],
referencedClasses: ["Browser", "SubWarsApp"]
}),
smalltalk.SubWarsApp);
